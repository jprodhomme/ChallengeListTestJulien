...
public class ChallengeList {
  ...
  /**
   * retourne vrai si les 2 lettres du début et de la fin sont les mêmes ex
   * "ABCDDFAB" : true
   */
  ...
  /**
   * retourne vrai si le mot contient des lettres différentes ex "AAAAAA" : false
   * "AAAHAA" : true
   */
  ...
  /**
   * retourne le tarif associé à l'âge : "gratuit" pour les moins de 3 ans
   * "reduit" pour les 3 à 12 ans "plein" pour les autres "erreur" si age négatif
   **/
  ...
  /**
   * retourne un message correspondant à la température : "ça gèle" si la
   * temperature est négative "ça caille" pour une temperature entre 0 et 5 "RAS"
   * pour une temperature en 5 et 90 "ça bouille" si la température est supérieure
   * à 90 "erreur" si la température est inférieure à -274
   **/
  ...
  /**
   * parcourt le tableau de noms et retourne une liste de tous les noms qui ont
   * une longueur > 2
   **/
  ...
  /**
   * parcourt le tableau de noms et retourne une liste de tous les noms qui
